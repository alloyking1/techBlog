<template>
    <div>
        ...
        <header class="cs-header navbar navbar-expand-lg navbar-light bg-light navbar-box-shadow navbar-sticky" data-scroll-header>
            ...
            <router-link to="/" class="navbar-brand order-lg-1 mx-auto ml-lg-0 pr-lg-2 mr-lg-4">
            
                <img class="d-none d-lg-block" width="153" src="img/logo/logo-dark.png" alt="TalkBox"/>
            ...
            <div class="cs-offcanvas-collapse order-lg-2" id="primaryMenu">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown dropdown-mega">
                        <router-link to="/blog" class="nav-link dropdown-toggle">Blog</router-link>
                    </li>
                    <li class="nav-item dropdown dropdown-mega active">
                        <router-link to="/podcast" class="nav-link dropdown-toggle">Podcast</router-link>
                    </li>
                    <li class="nav-item dropdown">
                        <router-link to="#" class="nav-link dropdown-toggle">Radio</router-link>
                    </li>
