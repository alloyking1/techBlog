        ...
        <header class="cs-header navbar navbar-expand-lg navbar-light bg-light navbar-box-shadow navbar-sticky" data-scroll-header>
            ...
            <div class="cs-offcanvas-collapse order-lg-2" id="primaryMenu">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown dropdown-mega active"><a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">Templates</a>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="docs/changelog.html">
                            ...
                            <div class="pl-3"><span class="d-block text-heading">Changelog<span class="badge badge-success ml-2">v1.1.1</span></span><small class="d-block text-muted">Regular updates</small></div>
                            </div></a></li>
                        <li class="dropdown-divider"></li>
