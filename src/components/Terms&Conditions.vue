        ...
        <div class="container pt-5">
          <div class="row">
            <div class="col-md-12">
              ...
              <p>Welcome to Tekiii!</p>
              <p>
                These terms and conditions outline the rules and regulations for
                the use of Tekiii's Website, located at https://tekiii.com.
              </p>
              <p>
                By accessing this website we assume you accept these terms and
                conditions. Do not continue to use Tekiii if you do not agree to
              ...
              <p>
                We employ the use of cookies. By accessing Tekiii, you agreed to
                use cookies in agreement with the Tekiii's Privacy Policy.
              </p>
              <p>
              ...
              <p>
                Unless otherwise stated, Tekiii and/or its licensors own the
                intellectual property rights for all material on Tekiii. All
                intellectual property rights are reserved. You may access this
                from Tekiii for your own personal use subjected to restrictions
                set in these terms and conditions.
              </p>
              <p>You must not:</p>
              <ul>
                <li>Republish material from Tekiii</li>
                <li>Sell, rent or sub-license material from Tekiii</li>
                <li>Reproduce, duplicate or copy material from Tekiii</li>
                <li>Redistribute content from Tekiii</li>
              </ul>
              <p>
              ...
              <p>
                ...
                website. Tekiii does not filter, edit, publish or review
                Comments prior to their presence on the website. Comments do not
                reflect the views and opinions of Tekiii,its agents and/or
                affiliates. Comments reflect the views and opinions of the
                person who post their views and opinions. To the extent
                permitted by applicable laws, Tekiii shall not be liable for the
              ...
              <p>
                Tekiii reserves the right to monitor all Comments and to remove
              ...
              <p>
                You hereby grant Tekiii a non-exclusive license to use,
              ...
              <p>
                ...
                of Tekiii; and (d) the link is in the context of general
              ...
              <p>
                ...
                by sending an e-mail to Tekiii. Please include your name, your
              ...
              <p>
                No use of Tekiii's logo or other artwork will be allowed for
