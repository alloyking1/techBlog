    ...
    <footer class="cs-footer bg-dark pt-5 pt-md-6 pt-lg-7">
      <div class="container pt-3 pt-md-0">
        <div class="pb-md-4 text-center">
          <h3 class="text-light font-weight-light mb-3">Still not convinced?</h3>
          <h2 class="text-light mb-5">Add premium support and lifetime updates to this.</h2><a class="btn btn-primary" href="https://themes.getbootstrap.com/product/around-multipurpose-template-ui-kit/" target="_blank" rel="noopener"><i class="fe-shopping-cart font-size-lg mr-2"></i>Buy Around</a>
        </div>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-6 col-md-7 pb-md-4 text-center">
            ...
            <form class="cs-subscribe-form validate" action="https://studio.us12.list-manage.com/subscribe/post?u=c7103e2c981361a6639545bd5&amp;amp;id=29ca296126" method="post" name="mc-embedded-subscribe-form" target="_blank" novalidate>
              ...
              </div><small class="form-text text-light opacity-50 pt-2">*Subscribe to our newsletter to receive early discount offers and new templates info.</small>
              <div class="cs-subscribe-status"></div>
            </form>
          </div>
        </div>
        <hr class="hr-light mt-5 pb-4">
        <p class="font-size-sm text-center mb-4 py-3"><span class="text-light opacity-50 mr-1">© All rights reserved. Made by</span><a class="nav-link-style nav-link-light" href="https://createx.studio/" target="_blank" rel="noopener">Createx Studio</a></p>
      </div>
    </footer>
</template>
