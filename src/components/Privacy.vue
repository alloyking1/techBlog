<template>
  <div>
    ...
    <div class="container mt-5">
      ...
      <p>
        At tekiii.com, accessible from https://tekiii.com, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by
        tekiii.com and how we use it.
      </p>
      <!-- /wp:paragraph -->
      ...
      <p>
        ...
        shared and/or collect in tekiii.com. This policy is not applicable to
      ...
      <!-- wp:paragraph -->
      <p>
        tekiii.com follows a standard procedure of using log files. These files
      ...
      <!-- wp:paragraph -->
      <p>
        Like any other website, tekiii.com uses 'cookies'. These cookies are
      ...
      <p>
        ...
        advertising partners of tekiii.com.
      </p>
      <!-- /wp:paragraph -->
      ...
      <p>
        ...
        advertisements and links that appear on tekiii.com, which are sent
      ...
      <!-- wp:paragraph -->
      <p>
        Note that tekiii.com has no access to or control over these cookies that
      ...
      <!-- wp:paragraph -->
      <p>
        tekiii.com's Privacy Policy does not apply to other advertisers or
      ...
      <!-- wp:paragraph -->
      <p>
        tekiii.com does not knowingly collect any Personal Identifiable
