        ...
        <div class="container-fluid pt-4 pb-5 py-lg-5">
          <div class="row align-items-center py-3">
            <div class="col-xl-6 col-lg-5 d-flex justify-content-end">
              <div
                class="pt-2 mx-auto mb-5 mb-lg-0 ml-lg-0 mr-xl-7 text-center text-lg-left"
                style="max-width: 495px"
              >
                <h1 class="display-4 text-light pb-2">
                  <span class="font-weight-light">Have a look </span>Around!
                </h1>
                <p
            ...
            <div class="col-xl-6 col-lg-7">
              <div class="cs-parallax ml-lg-n5" style="max-width: 920px">
                <div
                  class="cs-parallax-layer position-relative"
                  data-depth="0.1"
                >
                  <img
                    src="../assets/img/demo/presentation/intro/layer01.png"
                    alt="Layer"
                  />
                </div>
                <div
                  class="cs-parallax-layer"
                  style="z-index: 2"
                  data-depth="0.3"
                >
                  <img
                    src="../assets/img/demo/presentation/intro/layer02.png"
                    alt="Layer"
                  />
                </div>
          ...
          <div class="row justify-content-center mb-4 pb-2">
            <div class="col-xl-6 col-lg-7 col-md-8">
              ...
              <p class="text-muted text-center">
                ...
                User Account/Dashboard to Specialty pages like 404 and Coming
                Soon
              </p>
            </div>
          </div>
                      ...
                      <ul class="list-unstyled">
                        ...
                        <li class="mb-3">
                          <a
                            ...
                            >Sign In - Illustration</a
                          >
                        </li>
                        <li class="mb-3">
                          <a
                            class="font-weight-medium text-decoration-none"
                            href="signin-image.html"
                            >Sign In - Image</a
                          >
                        </li>
                        <li class="mb-3">
                  ...
                  <div class="row text-center text-sm-left">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                      ...
                      <ul class="list-unstyled">
                        ...
                        <li class="mb-3">
                          <a
                            class="font-weight-medium text-decoration-noneGrid"
                            href="shop-rs.html"
                            >Right Sidebar</a
                          >
                        </li>
          ...
          <div class="row align-items-center">
            ...
            <div class="col-md-6 text-center text-md-left">
              ...
              <p class="text-muted mb-5">
                Around based on advanced fully responsive Bootstrap grid. It
                looks great at any screen resolution and optimized for small
                touch screens. Around features 2 types of navigation for handeld
                devices and off-canvas sidebars that are easily accessible. All
                sliders used in the template have swipe support.
              </p>
              <div
              ...
              >
                ...
                <div class="pl-3 pl-sm-4">
                  <div class="text-nav text-left" style="max-width: 175px">
